...
createChart2(document.getElementById("league-filter").value, document.getElementById("team-filter-1").value, document.getElementById("team-filter-2").value);
...
d3.select("#league-filter").on("change", (event) => {
    ...
    createChart2(event.target.value, document.getElementById("team-filter-1").value, document.getElementById("team-filter-2").value);
