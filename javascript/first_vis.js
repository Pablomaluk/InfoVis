...
d3.csv("data/dataset.csv").then((data) => {
    ...
    let selectedGoalType = "Full Time";
    let selectedScorer = "Both";
    ...
    if (selectedScorer === "Home") {
        column = "home_";
    } else if (selectedScorer === "Away") {
        column = "away_";
    ...
    // Create boxplots for each matchday
    

    console.log(matchdayStatistics);
